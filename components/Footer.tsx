...
export function Footer() {
  ...
  return (
    <footer className="border-t border-white/10 bg-dark pb-8 pt-12">
      <div className="section-container">
          ...
          <div>
            <Link href="#" className="flex items-center gap-3" aria-label="Magical Mornings home">
              ...
              <div>
                ...
                <p className="text-xs text-white/45">{site.brandName}</p>
              </div>
            </Link>
          ...
          <div>
            ...
            <div className="mt-4 flex gap-3">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 text-white/60 transition-colors hover:border-primary/40 hover:text-primary-light"
        ...
        <div className="mt-12 border-t border-white/10 pt-8 text-center text-xs text-white/35">
          <p>
            © {year} {site.brandName}. All rights reserved. Educational coaching — not
